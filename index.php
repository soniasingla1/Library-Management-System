  ...
  <div class="container-fluid">
    ...
    <div class="nav navbar-nav navbar-right">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link nb"  href="admin/index.php"><font style="color:white">Admin Login</font></a>
        </li>
        <li class="nav-item">
...
<br><br>
 <div class="row">
   ...
   <div class="col-md-8" id="main_content">
     <center><h3  style="color:darkgreen;"> User Login Form</h3></center>
      <hr style="color:darkgreen;padding:2px">
...
<?php
    ...
    if(isset($_POST['login'])){
      $con=mysqli_connect("localhost","root","","lms");
       $query="select * from lms_data where email = '$_POST[email]'";
