        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <font style="color:green"><span><strong>
                            <center>
                                <h6 style="font-size:24px;text-decoration:underline;">Issued Books</h6>
                            </center>
                        </strong></span></font><br>
                <span>
                    <form>
                        <table class="table  table-success table-striped" width="900px" style="text-align:center;border: 3px solid green;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    $author = "";
                                    $book_no = "";
                                    $query = "select book_name,book_no,book_author from issued_books where student_id ='$_SESSION[student_id] and status=1'";
