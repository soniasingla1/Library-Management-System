                ...
                ?>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><?php echo $row['author_name']; ?></center>
                            </td>
                            
                            <td>
                            <center><button type="button" class="btn btn-success"><a href="edit_author.php?aid=<?php echo $row['author_id']?>" style="color:whitesmoke; text-decoration:none;">Edit</a></button>
                                    <button type="button" class="btn btn-success"><a href="delete_author.php?aid=<?php echo $row['author_id']?>"style="color:whitesmoke; text-decoration:none;">Delete</a</button>
                                </center>
                            </td>
                        </tr>
