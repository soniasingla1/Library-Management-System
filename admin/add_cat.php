...
<br>
 ...
 <div class="row">
     ...
     <div class="col-md-8">
     <h5 class="heading"><center style="font-size:23px;text-transform:capitalize;">Add New Category</center></h5>
     <br>
     ...
     <div class="mb-3 row">
   <label for="staticName" class="col-sm-2 col-form-label form_heading" >Name:</label>
   <div class="col-sm-10">
     <input type="text"  class="form-control form_text" name="cat_name"  id="staticName" >
   </div>
   </div>
   <br>
   
   <center><input type="submit" class="btn btn-success" name="add_cat" value="Add Category"></center>
   <?php
   
   if(isset($_POST['add_cat'])){
    $con=mysqli_connect("localhost","root","","lms");
    
    $query="INSERT INTO `category`(`cat_id`,`cat_name`) VALUES (' ','$_POST[cat_name]')";
