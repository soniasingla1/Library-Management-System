...
<body>
 ...
 <div class="row">
     ...
     <div class="col-md-8">
     <h5 class="heading"><center style="font-size:25px;text-transform:capitalize;">Add New Author</center></h5>
     <br>
     <form action="" method="post">
     
     <div class="mb-3 row">
   <label for="staticName" class="col-sm-2 col-form-label form_heading" style="color:darkgeen;font-size:larger">Name:</label>
   <div class="col-sm-10">
     <input type="text"  class="form-control form_text" name="author_name"  id="staticName"  >
   </div>
   </div>
   <br>
   
   <center><input type="submit" class="btn btn-success" name="add_author" value="Add Author"></center>
   <?php
   
   if(isset($_POST['add_author'])){
    $con=mysqli_connect("localhost","root","","lms");
    
    $query="INSERT INTO `authors`(`author_id`, `author_name`) VALUES ('','$_POST[author_name]')";
