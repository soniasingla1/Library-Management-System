                ...
                <table class="table  table-success table-striped" width="900px" style="text-align:center;border: 3px solid green;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            $student_name = "";
                             $issue_date="";
                            $query = "select issued_books.book_name,issued_books.book_no,issued_books.book_author,issued_books.issue_date,lms_data.name from issued_books left join lms_data on issued_books.student_id=lms_data.srno";
