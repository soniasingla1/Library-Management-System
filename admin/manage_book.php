...
<body>
   ...
   <br>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <table class="table  table-success table-striped table-bordered border-light">
                <thead>
                    <tr>
                        <th scope="col">
                ...
                ?>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><?php echo $row['book_name']; ?></center>
                            </td>
                            <td>
                                <center><?php echo $row['author_id']; ?></center>
                            </td>
                            <td>
                                <center><?php echo $row['cat_id']; ?></center>
                            </td>
                            <td>
                                <center><?php echo $row['book_no']; ?></center>
                            </td>
                            <td>
                                <center><?php echo $row['book_price']; ?></center>
                            </td>
                            <td>
                                <center><button type="button" class="btn btn-success"><a href="edit_book.php?bn=<?php echo $row['book_no']?>" style="color:whitesmoke; text-decoration:none;">Edit</a></button>
                                    <button type="button" class="btn btn-success"><a href="delete_book.php?bn=<?php echo $row['book_no']?>"style="color:whitesmoke; text-decoration:none;">Delete</a</button>
                                </center>
                            </td>
                        </tr>
