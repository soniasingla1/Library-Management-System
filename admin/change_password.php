...
<br><font style="color:green"><span><strong><center  style="color:darkgreen;font-size:28px;text-transform:capitalize;">Welcome <?php echo $_SESSION['name'];?></center></strong></span></font><br>
<br>
...
<div class="col-md-4">
    <form action="update_password.php" method="post">
        <div class="form-group">
            <label class="form_heading" style="color:darkgreen;font-size:larger;"> Old Password:</label>
            <input type="password" name="old_password" class="form-control form_text">
</div><br>
<div class="form-group">
            <label class="form_heading" style="color:darkgreen;font-size:larger;"> New Password:</label>
            <input type="password" name="new_password" class="form-control form_text">
</div>
<br>

<br>
<center><input type="submit" class="btn btn-success" name="update" value=" Update"></center></form>
