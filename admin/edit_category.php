...
<body>
 ...
 <div class="row">
     ...
     <div class="col-md-8">
     <h5 class="heading">
     <center style="font-size:25px;text-transform:capitalize;">Edit Category</center>
      </h5>
      <br>
   ...
   <div class="mb-3 row">
   <label for="staticName" class="col-sm-2 col-form-label form_heading" style="color:dargreen;font-size:large">Category Id:</label>
   <div class="col-sm-10">
   ...
   <br>
   <div class="mb-3 row">
   <label for="staticName" class="col-sm-2 col-form-label form_heading" style="color:dargreen;font-size:large;">Category Name:</label>
   <div class="col-sm-10">
     <input type="text"  class="form-control form_text" name="cat_name" value="<?php echo $cat_name; ?>"  id="staticName" required >
   </div>
   </div>
   <br>
