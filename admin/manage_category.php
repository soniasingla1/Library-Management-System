                ...
                ?>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center><?php echo $row['cat_name']; ?></center>
                            </td>
                            
                            <td>
                                <center><button type="button" class="btn btn-success"><a href="edit_category.php?cid=<?php echo $row['cat_id']?>" style="color:whitesmoke; text-decoration:none;">Edit</a></button>
                                    <button type="button" class="btn btn-success"><a href="delete_category.php?cid=<?php echo $row['cat_id']?>"style="color:whitesmoke; text-decoration:none;">Delete</a></button>
                                </center>
