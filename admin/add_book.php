...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <h5 class="heading">
      <center style="font-size:25px;text-transform:capitalize;">Add New Book</center>
      </h5>
      <br>
      <form action="" method="post">
      <div class="mb-3 row">
          <label for="staticName" class="col-sm-2 col-form-label form_heading" style="color:darkgreen;font-size:larger">Book Id:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" name="book_id " id="staticName" >
          </div>
        </div>
        <br>
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" name="book_name" id="staticName" >
          </div>
        </div>
        <br>
        <div class="mb-3 row">
          <label for="staticName" class="col-sm-2 col-form-label form_heading"style="color:darkgreen;font-size:larger">Author Id:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" name="author_id" id="staticAuthor"  required>
          </div>
        </div>
        <br>
        <div class="mb-3 row">
          <label for="staticName" class="col-sm-2 col-form-label form_heading"style="color:darkgreen;font-size:larger">Category No:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" id="staticName" name=" cat_id" required>
          </div>
        </div>
        <br>
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" id="staticName" name=" book_no" required>
          </div>
        </div>
        <br>
        <div class="mb-3 row"><label for="staticName" class="col-sm-2 col-form-label form_heading" style="color:darkgreen;font-size:larger">Price:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control form_text" id="staticName" name="book_price" required>
          </div>
        </div>
        <br>
        <center><input type="submit" class="btn btn-success" name="add_book" value="Add Book"></center>
        <?php
...
$book_price=(int)$_POST['book_price'];
  if(isset($_POST['add_book'])){
    ...
    $query="INSERT INTO `books`(`book_id`, `book_name`, `author_id`, `cat_id`, `book_no`, `book_price`) VALUES (' $book_id','$book_name','$author_id','$cat_id',' $book_no','$book_price')";
